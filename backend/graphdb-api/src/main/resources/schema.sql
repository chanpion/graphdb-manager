...
CREATE TABLE IF NOT EXISTS `query_history` (
    ...
    KEY `idx_qh_graph_instance_id` (`graph_instance_id`),
...
CREATE TABLE IF NOT EXISTS `query_script` (
    ...
    `deleted` int DEFAULT 0 COMMENT '逻辑删除标记（0-未删除，1-已删除）',
    PRIMARY KEY (`id`),
    KEY `idx_qs_connection_id` (`connection_id`),
    KEY `idx_qs_graph_instance_id` (`graph_instance_id`),
    KEY `idx_qs_name` (`name`),
...
CREATE TABLE IF NOT EXISTS `import_task` (
    ...
    `deleted` int DEFAULT 0 COMMENT '逻辑删除标记（0-未删除，1-已删除）',
    PRIMARY KEY (`id`),
    KEY `idx_it_connection_id` (`connection_id`),
    KEY `idx_it_graph_instance_id` (`graph_instance_id`),
